...
- (instancetype) initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        [_homePageTableView addSubview:_homePageController];
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (_isInternetExist == NO) {
        ...
        [cell.titleImageView sd_setImageWithURL:urlSting placeholderImage:[UIImage imageNamed:@"placeholder.jpg"]];
    } else {
        cell.titleLabel.text = _titleMutableArray[indexPath.row];
        NSString *urlSting = _pictureMutableArray[indexPath.row];
        [cell.titleImageView sd_setImageWithURL:[NSURL URLWithString:urlSting] placeholderImage:[UIImage imageNamed:@"placeholder.jpg"]];
